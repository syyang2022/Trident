...
if __name__ == "__main__":
    ...
    classes_path    = 'model_data/gc10_classes.txt'
    #---------------------------------------------------------------------#
    #   anchors_path    代表先验框对应的txt文件，一般不修改。
    #   anchors_mask    用于帮助代码找到对应的先验框，一般不修改。
    #---------------------------------------------------------------------#
    anchors_path    = 'model_data/yolo_anchors_gc10_512.txt'
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    #model_path      = 'D:\\DLmode\\yolo3-pytorch\\model_data\\hr_s_31_25_1.pth'
    #model_path      = 'D:\\DLmode\\yolo3-pytorch\\logs\\ep258-loss0.047-val_loss0.053.pth'
    model_path      = ''
    #------------------------------------------------------#
    ...
    model = HrShuffleNet(anchors_mask, num_classes)
    if not pretrained:
        weights_init(model)
    if model_path != '':
        #------------------------------------------------------#
